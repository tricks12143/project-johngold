...
/*
		$("#team").pagination({
		items: $("input[name=numoflimit-team]").val(),
		contents: 'contents-team',
		previous: 'Previous',
		next: 'Next',
		position: 'bottom',
	});
...
1;b<=Math.min(a.total,a.maxVisible);b++)c=c.concat(['<li data-lp="',b,'" class="page-item"><a class="page-link" href="',g(b),'">',b,"</a></li>"]);a.next&&(b=a.leaps&&a.total>a.maxVisible?Math.min(a.maxVisible+1,a.total):2,c=c.concat(['<li data-lp="',b,'" class="page-item ',a.nextClass,'"><a class="page-link" href="',g(b),'">',a.next,"</a></li>"]));a.firstLastUse&&(c=c.concat(['<li data-lp="',a.total,'" class="page-item last"><a class="page-link" href="',g(a.total),'">',a.last,"</a></li>"]));c.push("</ul>");d.find("ul.bootpag").remove();d.append(c.join(""));c=d.find("ul.bootpag");d.find("li").click(function(){var b=
