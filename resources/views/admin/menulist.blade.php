					  	...
					  	@if(count($pagemains) > 0)
							...
							<div class="johngold-minipanels">
								...
								<div class="row">
									...
									<a href='{{ url("/deletemenu/{$pagemain->page_id}") }}' class="johngold-minipanels-body-right-a" style="font-size:14px;">
									...
									<a href='{{ url("/dashboard/updatepage/{$pagemain->page_id}") }}' class="johngold-minipanels-body-right-a" style="font-size:14px;">
				          	...
				          	<form class="form-horizontal" method="POST" action="{{ url('/insertmenu') }}">
								  ...
								  <fieldset>
								    ...
								    <div class="form-group">
								      ...
								      <div class="col-lg-9">
								        <input type="text" class="form-control" id="template" name="template" placeholder="Template">
								      </div>
								    </div>
